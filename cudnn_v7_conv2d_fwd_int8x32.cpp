...
int main(int argc, char const *argv[]) {
  ...
  cudnnDataType_t dataType = CUDNN_DATA_INT8x32;
  ...
  checkCUDNN(cudnnReorderFilterAndBias(/*handle=*/cudnn,
                                       /*filterDesc=*/kernel_descriptor,
                                       /*reorderType=*/CUDNN_DEFAULT_REORDER,
                                       /*filterData=*/w,
                                       /*reorderedFilterData=*/reordered_w,
                                       /*reorderBias=*/0,
                                       /*biasData=*/nullptr,
  ...
  checkCUDNN(cudnnConvolutionForward(/*handle=*/cudnn,
                                     /*alpha=*/&alpha,
                                     /*xDesc=*/input_descriptor,
                                     /*x=*/x,
                                     /*wDesc=*/kernel_descriptor,
